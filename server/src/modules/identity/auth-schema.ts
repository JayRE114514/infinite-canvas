...
export const workspaceMembers = pgTable(
    ...
    (table) => [uniqueIndex("workspace_members_workspace_user_unique").on(table.organizationId, table.userId)],
);
...
export const workspaceInvitations = pgTable(
    ...
    (table) => [index("workspace_invitations_workspace_email_idx").on(table.organizationId, table.email)],
);
