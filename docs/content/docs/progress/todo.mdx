...
- Implement the account, Workspace, PostgreSQL ledger, object storage, durable AI-task queue, and owner-maintained Provider Adapter platform described in the [Backend Platform Architecture Design](../../../superpowers/specs/2026-08-26-backend-platform-architecture-design.md).
