...
- 后端平台建设：按照[后端平台架构设计](../../../superpowers/specs/2026-08-26-backend-platform-architecture-design.md)实现账号与 Workspace、PostgreSQL 积分账本、对象存储、可靠 AI 任务队列和仅由项目所有者维护的 Provider Adapter。
