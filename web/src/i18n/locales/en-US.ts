export default {
    ...
    auth: {
        shell: {
            ...
            title: "Return to a quieter place for making things.",
            description: "Your account connects your identity and Workspaces. The canvas, assets, and creative flow stay familiar, lightweight, and focused.",
        },
        checkingSession: "Checking your session…",
        sessionLoadFailed: "We could not confirm your session",
        sessionLoadFailedDescription: "Check your connection and retry. Protected content stays hidden while your session is uncertain.",
        sessionExpiredRedirect: "Your session expired. Returning to sign in…",
        signOut: "Sign out",
        fields: {
            name: "Name",
        ...
        login: {
            ...
            title: "Sign in to Infinite Canvas",
            description: "Continue to your personal and team Workspaces.",
            rememberMe: "Keep me signed in",
            submit: "Sign in",
            noAccount: "New to Infinite Canvas?",
        ...
        invitation: {
            ...
            acceptingTitle: "Joining the team Workspace",
            acceptingDescription: "We are validating this invitation for your signed-in account.",
            synchronizingTitle: "Refreshing your Workspace list",
            synchronizingDescription: "The invitation is accepted. We are waiting for the team Workspace to become available.",
            successEyebrow: "Invitation accepted",
            successTitle: "You joined the team",
            successDescription: "The team Workspace is now in your Workspace list.",
            successNamedDescription: "You joined “{{name}}” and it is now your active Workspace.",
            enterWorkspace: "Enter Workspace",
            errorEyebrow: "Invitation unavailable",
            errorTitle: "This invitation cannot be accepted",
            errorDescription: "It may be expired, already handled, or intended for another signed-in email.",
            syncErrorEyebrow: "Invitation accepted",
            syncErrorTitle: "The team Workspace is not ready yet",
            syncErrorDescription: "Your membership is saved. Retry the Workspace refresh without accepting the invitation again.",
            retryAccept: "Retry acceptance",
            retrySync: "Retry Workspace refresh",
            backHome: "Back to home",
            sessionTitle: "We could not confirm your session",
            sessionDescription: "Restore your connection before continuing with this invitation.",
            retrySession: "Check again",
            errors: {
                sessionFailed: "Session check failed. Please retry.",
                notFound: "This invitation does not exist or was already handled",
                expired: "This invitation expired. Ask a team admin to send another.",
                wrongRecipient: "The signed-in account is not the invitation recipient",
                alreadyMember: "This account is already a member of the team",
                acceptFailed: "Could not accept the invitation. Please retry.",
                syncFailed: "Could not refresh your Workspace list. Please retry.",
                syncMissing: "The accepted team is not in your Workspace list yet. Please retry.",
            },
        },
        errors: {
    ...
    workspace: {
        ...
        switcher: {
            title: "Workspaces",
            open: "Switch Workspace. Current Workspace: {{name}}",
        ...
        create: {
            ...
            slug: "Workspace slug",
            slugPlaceholder: "visual-team",
            slugHint: "Use lowercase letters, numbers, and single hyphens only.",
            slugRequired: "Enter a Workspace slug",
        ...
        members: {
            ...
            removeDescription: "“{{name}}” will lose access to this Workspace.",
            remove: "Remove",
            removeNamed: "Remove member {{name}}",
            memberRemoved: "Member removed",
            pendingInvitations: "Pending invitations",
            noPendingInvitations: "No pending invitations",
            cancelInvitation: "Cancel invite",
            cancelTitle: "Cancel this invitation?",
            cancelDescription: "The invitation link sent to {{email}} will stop working immediately.",
            cancelNamed: "Cancel the invitation for {{email}}",
            invitationCanceled: "Invitation canceled",
        },
        errors: {
            personalSingleMember: "A personal Workspace can contain only its owner",
            forbidden: "You no longer have access to this Workspace",
            network: "Network connection failed. Please retry.",
            adminRequired: "Owner or admin access is required",
            invitationConflict: "This user is already a member or has a pending invitation",
            ownerCannotBeRemoved: "The Workspace owner cannot be removed",
            slugTaken: "This Workspace slug is already in use",
            loadFailed: "Workspace loading failed. Please retry.",
            createFailed: "Could not create the Workspace. Please retry.",
            inviteFailed: "Could not send the invitation. Please retry.",
            cancelInvitationFailed: "Could not cancel the invitation. Please retry.",
            removeMemberFailed: "Could not remove the member. Please retry.",
            membersLoadFailed: "Could not load members",
            invitationsLoadFailed: "Could not load invitations",
        },
    },
    settingsPanels: {
    ...
    canvas: {
        ...
        importPartialFailed: "{{count}} canvases could not be imported. Please retry.",
        opening: "Opening canvas...",
        loading: "Loading canvases...",
        listFailed: "Could not load the canvas list",
        createFailed: "Could not create the canvas. Please retry.",
        renameFailed: "Could not rename the canvas. Please retry.",
        ...
        deleteFailed: "No verifiable deletion receipt was received. The canvas and local draft were preserved.",
        deletePartialFailed: "Some canvases had no verifiable deletion receipt. Unconfirmed canvases and local drafts were preserved.",
        deleteLocalCleanupPending: "The canvas was deleted on the server. Local drafts are not cleaned up yet and will be retried later.",
        ...
        recovery: { tombstoned: "This canvas was confirmed deleted. Local recovery has stopped." },
        conflict: {
            ...
            reload: "Load server copy",
            exportDraft: "Export local draft",
            exportDraftMultiple: "Export local drafts ({{count}})",
            reloaded: "Server copy loaded",
            reloadFailed: "Could not load the server copy",
            exported: "Local draft exported",
            exportFailed: "Could not export the local draft",
            draftMissing: "No local draft found",
            draftName: "{{title}}-local-draft",
        ...
        save: {
            ...
            unsaved: "Unsaved",
            saved: "Saved",
            failed: "Save failed; not synced to the cloud",
            retry: "Retry",
    ...
    config: {
        ...
        webdav: {
            ...
            completed: "Sync complete: {{assets}} assets, {{records}} records, and {{files}} files ({{bytes}}) uploaded",
            domains: {
                assets: "My Assets",
