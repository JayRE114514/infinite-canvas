export default {
    ...
    auth: {
        shell: {
            eyebrow: "为创作留出空间",
            title: "从一个安静的空间，继续你的创作。",
            description: "账号只负责连接你的身份与 Workspace。画布、素材和创作流程仍保持熟悉、轻量且专注。",
        },
        checkingSession: "正在确认登录状态…",
        sessionLoadFailed: "暂时无法确认登录状态",
        sessionLoadFailedDescription: "请检查网络后重试，我们不会在状态不明确时展示受保护内容。",
        sessionExpiredRedirect: "登录已过期，正在返回登录页…",
        signOut: "退出登录",
        fields: {
            name: "名称",
        ...
        invitation: {
            eyebrow: "团队邀请",
            acceptingTitle: "正在加入团队空间",
            acceptingDescription: "我们正在为当前登录账号验证这条邀请。",
            synchronizingTitle: "正在刷新 Workspace 列表",
            synchronizingDescription: "邀请已接受，正在等待团队 Workspace 出现在你的列表中。",
            successEyebrow: "邀请已接受",
            successTitle: "你已加入团队",
            successDescription: "团队 Workspace 已加入你的空间列表。",
            successNamedDescription: "你已加入「{{name}}」，并已将它设为当前 Workspace。",
            enterWorkspace: "进入 Workspace",
            errorEyebrow: "无法接受邀请",
            errorTitle: "这条邀请暂时不可用",
            errorDescription: "邀请可能已过期、已处理，或不属于当前登录邮箱。",
            syncErrorEyebrow: "邀请已接受",
            syncErrorTitle: "团队 Workspace 暂未就绪",
            syncErrorDescription: "你的成员关系已经保存。请仅重试刷新 Workspace，无需再次接受邀请。",
            retryAccept: "重试接受邀请",
            retrySync: "重试刷新 Workspace",
            backHome: "返回首页",
            sessionTitle: "无法确认登录状态",
            sessionDescription: "请先恢复网络连接，再继续处理邀请。",
            retrySession: "重新检查",
            errors: {
                sessionFailed: "登录状态检查失败，请重试",
                notFound: "邀请不存在或已被处理",
                expired: "邀请已过期，请联系团队管理员重新发送",
                wrongRecipient: "当前账号不是这条邀请的接收者",
                alreadyMember: "当前账号已经是该团队成员",
                acceptFailed: "接受邀请失败，请稍后重试",
                syncFailed: "刷新 Workspace 列表失败，请重试",
                syncMissing: "已接受的团队暂未出现在 Workspace 列表中，请重试",
            },
        },
        errors: {
    ...
    workspace: {
        ...
        switcher: {
            title: "Workspace",
            open: "切换 Workspace，当前为{{name}}",
            members: "成员与邀请",
            create: "创建团队 Workspace",
        },
        create: {
            ...
            slugHint: "仅使用小写字母、数字和单个连字符。",
            slugRequired: "请输入空间标识",
            slugInvalid: "请使用小写字母、数字和连字符",
            submit: "创建",
            success: "团队 Workspace 已创建",
        },
        members: {
            title: "「{{name}}」成员",
            ...
            empty: "暂无成员",
            removeTitle: "移除成员？",
            removeDescription: "「{{name}}」将无法继续访问这个 Workspace。",
            remove: "移除",
            removeNamed: "移除成员{{name}}",
            memberRemoved: "成员已移除",
            pendingInvitations: "待接受邀请",
            noPendingInvitations: "暂无待接受邀请",
            cancelInvitation: "取消邀请",
            cancelTitle: "取消这条邀请？",
            cancelDescription: "发给 {{email}} 的邀请链接将立即失效。",
            cancelNamed: "取消发给{{email}}的邀请",
            invitationCanceled: "邀请已取消",
        },
        errors: {
            personalSingleMember: "个人 Workspace 只能包含所有者",
            forbidden: "你已无权访问这个 Workspace",
            network: "网络连接失败，请稍后重试",
            adminRequired: "需要所有者或管理员权限",
            invitationConflict: "该用户已加入或已收到邀请",
            ownerCannotBeRemoved: "不能移除 Workspace 所有者",
            slugTaken: "该空间标识已被使用",
            loadFailed: "Workspace 加载失败，请稍后重试",
            createFailed: "创建 Workspace 失败，请稍后重试",
            inviteFailed: "发送邀请失败，请稍后重试",
            cancelInvitationFailed: "取消邀请失败，请稍后重试",
            removeMemberFailed: "移除成员失败，请稍后重试",
            membersLoadFailed: "成员列表加载失败",
            invitationsLoadFailed: "邀请列表加载失败",
        },
    },
    settingsPanels: {
    ...
    canvas: {
        ...
        importPartialFailed: "{{count}} 个画布导入失败，请稍后重试",
        opening: "正在打开画布...",
        loading: "正在加载画布...",
        listFailed: "画布列表加载失败",
        createFailed: "新建画布失败，请稍后重试",
        renameFailed: "重命名失败，请稍后重试",
        renamed: "重命名成功",
        rename: { localOnly: "标题仅保存在本地草稿", conflictHint: "该画布存在版本冲突，请打开画布后处理" },
        deleteFailed: "未收到可验证的删除回执，画布与本地草稿均已保留",
        deletePartialFailed: "部分画布未收到可验证的删除回执，未确认项与本地草稿均已保留",
        deleteLocalCleanupPending: "画布已在服务端删除，本地草稿暂未清理，稍后会自动重试",
        exportFailed: "导出失败，请稍后重试",
        openFailed: "打开画布失败，请稍后重试",
        notFound: "画布不存在或已被删除",
        retry: "重试",
        agent: { notReady: "画布尚未就绪，请稍后再试" },
        recovery: { tombstoned: "该画布已确认删除，本地恢复已停止" },
        conflict: {
            title: "版本冲突",
            ...
            reloaded: "已载入服务端版本",
            reloadFailed: "载入服务端版本失败",
            exported: "本地草稿已导出",
            exportFailed: "本地草稿导出失败",
            draftMissing: "找不到本地草稿",
            draftName: "{{title}}-本地草稿",
    ...
    config: {
        ...
        webdav: {
            ...
            preparing: "准备同步",
            failed: "WebDAV 同步失败",
            completed: "同步完成：{{assets}} 个资产，{{records}} 条记录，本次上传 {{files}} 个文件 {{bytes}}",
            domains: {
                assets: "我的资产",
